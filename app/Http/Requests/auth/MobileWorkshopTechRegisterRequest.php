...
class MobileWorkshopTechRegisterRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'role'      => "required|string|in:maintenanceMobileWorkshop",
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'role.in' => 'The role must be maintenanceMobileWorkshop.',
        ];
    }
